function getProjects() {
    const urlGitHub = "https://api.github.com/users/grazi230/repos"; // Inserir o nome de usuário do seu github
  ...
  function showProjects(data) {
    ...
    data.forEach((repo) => {
      ...
      a.href = repo["hhttps://github.com/grazi230?tab=repositories"]; // Link para o repositório no GitHub
      a.target = "_blank";
